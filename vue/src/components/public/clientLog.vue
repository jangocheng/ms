...
<template>
  <div class="app-container">
    <div class="filter-container">
      <el-form>
        <el-form-item>
          ...
          <el-button type="primary" icon="el-icon-search" v-if="hasPerm('clientLog:list')" @click="getList" size="small">查询
          </el-button>
        </el-form-item>
      </el-form>
    </div>
    <el-table ref="multipleTable" :data="list" v-loading.body="listLoading" element-loading-text="拼命加载中" border fit
      ...
      <el-table-column  align="center" label="uuid1" prop="uuid1" width="150"/>
      <el-table-column  align="center" label="uuid2" prop="uuid2" width="150"/>
      <el-table-column  align="center" label="用户ID" prop="userid"/>
      <el-table-column  align="center" label="手机号码" prop="userphone" width="120"/>
      <el-table-column  align="center" label="日志级别" prop="level" width="60"/>
      <el-table-column  align="center" label="标题" prop="title"/>
      <el-table-column  align="center" label="日志时间" prop="logtime" width="180"/>
  ...
  export default {
    ...
    methods:{
      getList(){
        ...
        this.api({
          url: '/public/clientLog/list?date='+this.filter.date + '&phoneNo='+ this.filter.phoneNo,
          method: 'get',
          headers: {
